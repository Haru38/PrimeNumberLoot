...
contract PrimeNumberLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function claim(uint256 primeNumber) public nonReentrant {
        require(PRIMES(primeNumber), "It's not a prime number.");
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "PrimeNUmberLoot is an NFT for prime numbers up to 10000. The background color and font changes depending on the number of digits in the prime number.", "image": "data:image/svg+xml;base64,',
